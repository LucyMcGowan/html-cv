...
**BA** in Religious Studies and Romance Languages, May 2012 \fn{UNC Chapel Hill}  
...
\needspace{4\baselineskip} ***College-wide***
...
\needspace{4\baselineskip} ***Service on Editorial Boards***
...
\needspace{4\baselineskip}***Service for the American Statistical Association***
...
\needspace{4\baselineskip}***Service for the International Biometric Society (ENAR)***
...
\needspace{4\baselineskip}***Referee***
...
\needspace{4\baselineskip}***Chaired Conference Sessions***
...
funding %>%
  ...
  glue::glue_data("\\tabbedparagraph{<start><ifelse(!is.na(end), glue::glue('-{end}'), '\\\\hspace{1cm}')>}{<funder>, \\textit{<what>}<ifelse(!is.na(PI), glue::glue(' (PI: {PI})'), '')>\\\\ Role: <role>  <ifelse(!is.na(amount), glue::glue('({amount})'), '')>} \n\n",
                  .open = "<", .close = ">")
```
